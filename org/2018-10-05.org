       ...
       "modules": [
         ...
         },
         {
           ...
           "sources": [
             {
               "type": "file",
               "url": "https://codeload.github.com/golang/time/tar.gz/master",
               "sha256": "85a7de8cca3cd46e798f0f1af766fb5a889ee495e7213b34fe64e3c956f4c9d2"
             }
           ],
           "buildsystem": "simple",
           "build-commands": [
             "tar zxf master",
             "mkdir -p /app/src/golang.org/x",
             "mv time-master /app/src/golang.org/x/time"
           ]
         },
         {
           "name": "snappy",
         ...
         },
         {
           ...
           "sources": [
             {
               "type": "file",
               "url": "https://codeload.github.com/yuin/gluamapper/tar.gz/master",
               "sha256": "fa7e9b62b59cad09c89b50d95df86f29ef33744a3d8440fa6b1024a33e1d3107"
             }
           ],
           "buildsystem": "simple",
           "build-commands": [
             ...
             "mv gluamapper-master /app/src/github.com/yuin/gluamapper"
           ]
         },
         {
           "name": "gopher-lua",
           "sources": [
             {
               "type": "file",
               "url": "https://codeload.github.com/yuin/gopher-lua/tar.gz/master",
               "sha256": "28fca2291ece9059c427d70194d979244da90fae4ba631687445a9bd0dc76e96"
             }
           ],
           "buildsystem": "simple",
           "build-commands": [
             "tar zxf master",
             "mkdir -p /app/src/github.com/yuin",
             "mv gopher-lua-master /app/src/github.com/yuin/gopher-lua"
           ]
         },
         {
           "name": "mapstructure",
         ...
         },
         {
           ...
           "sources": [
             {
               "type": "file",
               "url": "https://codeload.github.com/bitmark-inc/bitmarkd/tar.gz/v0.10.1",
               "sha256": "706912a1f278ee63ea6b7c8fb4f1d47f2f5e955c4e623dca9f3b57e3884bb93d"
             }
           ],
           "buildsystem": "simple",
           "build-commands": [
             "tar zxf v0.10.1",
             "mv bitmarkd-0.10.1 /app/src/github.com/bitmark-inc/bitmarkd",
